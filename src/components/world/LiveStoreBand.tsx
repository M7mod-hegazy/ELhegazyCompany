  ...
  return (
    <section className="relative mx-auto max-w-5xl px-6 py-12">
      <m.a
        ...
        className="group relative block overflow-hidden rounded-3xl border border-brass/20 bg-gradient-to-br from-ink-800/80 to-ink-900/80 px-8 py-10 text-center transition-all duration-500 hover:border-brass/50"
      >
        <div
          aria-hidden
        ...
        <p className="relative mt-4 font-display text-2xl font-semibold text-bone sm:text-3xl">
          {t("promise")}
        </p>
